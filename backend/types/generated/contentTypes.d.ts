...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Editorial content with an explicit application author';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A published unit of learning owned by an instructor';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A student's membership in one course";
...
export interface ApiLessonProgressLessonProgress
  extends Struct.CollectionTypeSchema {
  collectionName: 'lesson_progress_records';
  info: {
    description: 'Persistent proof that one student completed one lesson';
    displayName: 'Lesson Progress';
    pluralName: 'lesson-progress-records';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An ordered text or video lesson within a course';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An immutable, server-graded student quiz submission';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A server-graded MCQ quiz belonging to a course';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
